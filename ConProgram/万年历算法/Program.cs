...
namespace 万年历算法
{
    ...
    class Program
    {
       static int DateDiff(DateTime DateTime1, DateTime DateTime2)
        {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("周：" + cc.CaculateWeekDay());
            DateTime dtNow = Convert.ToDateTime("2020-6-7");
            int days = DateTime.DaysInMonth(dtNow.Year, dtNow.Month);
            Console.WriteLine(days);



            int a = cc.CaculateWeekDay();
            for (int i = 0; i < 42; i++)
            {
                if (i<a||i> days)
                {
            ...
            Console.WriteLine("=============");
          DayOfWeek aa = dt.DayOfWeek;
            Console.WriteLine(aa);

            Console.WriteLine(dt.AddDays(1 - dt.Day)) ;
            ...
            Console.WriteLine(Convert.ToDateTime("2020年6月8日"));


            Console.WriteLine(DateDiff(  Convert.ToDateTime("2020-6-7"), Convert.ToDateTime("2020-5-7")));
